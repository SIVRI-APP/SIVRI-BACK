...
import edu.unicauca.SivriBackendApp.common.security.credential.IGetAuthorities;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  private Set<SimpleGrantedAuthority> getAuthorities (String userEmail){
    ...
    //Proyecto
    // Funcionario
    List<IGetAuthorities> userAuthorities = credentialRepository.getAuthoritiesFuncionario(userEmail);
