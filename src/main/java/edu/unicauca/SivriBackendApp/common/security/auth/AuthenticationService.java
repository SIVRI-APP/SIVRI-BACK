...
import edu.unicauca.SivriBackendApp.common.security.config.JwtService;
...
public class AuthenticationService {
  ...
  private void saveUserToken(Credential credential, String jwtToken) {
  ...
  private void revokeAllUserTokens(Credential credential) {
