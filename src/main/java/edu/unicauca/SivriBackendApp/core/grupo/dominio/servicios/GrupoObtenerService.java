...
public class GrupoObtenerService implements GrupoObtenerCU {
    ...
    @Override
    public Respuesta<Page<List<ListarGruposPorIdDirector>>> obtenerGruposPorIdDirector(int pageNo, int pageSize, int idDirector) {
        Pageable pageable= PageRequest.of(pageNo,pageSize);
        //TODO validar que el usuario sea director
        Page<List<ListarGruposPorIdDirector>> respuestaBd=grupoObtenerREPO.obtenerGruposPorIdDirector(pageable,idDirector);
        if (respuestaBd.isEmpty()){
