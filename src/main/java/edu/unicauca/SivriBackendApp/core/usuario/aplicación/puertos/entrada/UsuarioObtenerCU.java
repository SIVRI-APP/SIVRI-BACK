...
public interface UsuarioObtenerCU {
     ...
     */
    Respuesta<Page<UsuarioListarConFiltroProyección>> listarConFiltro(int pageNo, int pageSize, String correo, TipoDocumento tipoDocumento, String numeroDocumento, String nombres, String apellidos, TipoUsuario tipoUsuario, Integer organismoDeInvestigacionId);
    ...
    /**
     ...
     //     */
    Respuesta<UsuarioInformaciónDetalladaProyección> obtenerUsuarioInformaciónDetallada(long usuarioId);
