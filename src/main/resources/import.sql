...
INSERT INTO usuario (ID, CORREO, TIPO_DOCUMENTO, NUMERO_DOCUMENTO, SEXO, TIPO_USUARIO, NOMBRE, APELLIDO, TELEFONO, PROGRAMA_ID) VALUES (2, 'yurani@unicauca.edu.co', 'CEDULA_CIUDADANIA', '10612', 'MASCULINO', 'DOCENTE', 'Yurani', 'Guevara', '3225864404',1);
INSERT INTO usuario (ID, CORREO, TIPO_DOCUMENTO, NUMERO_DOCUMENTO, SEXO, TIPO_USUARIO, NOMBRE, APELLIDO, TELEFONO, PROGRAMA_ID) VALUES (3, 'yurany@unicauca.edu.co', 'CEDULA_CIUDADANIA', '10619', 'FEMENINO', 'DOCENTE', 'Yurany', 'Guevara', '3225864404',2);
INSERT INTO usuario (ID, CORREO, TIPO_DOCUMENTO, NUMERO_DOCUMENTO, SEXO, TIPO_USUARIO, NOMBRE, APELLIDO, TELEFONO, PROGRAMA_ID) VALUES (4, 'andrea@unicauca.edu.co', 'CEDULA_CIUDADANIA', '10614', 'FEMENINO', 'DOCENTE', 'Andrea', 'Robles', '3225864404',3);
INSERT INTO usuario (ID, CORREO, TIPO_DOCUMENTO, NUMERO_DOCUMENTO, SEXO, TIPO_USUARIO, NOMBRE, APELLIDO, TELEFONO, PROGRAMA_ID) VALUES (5, 'maicol@unicauca.edu.co', 'CEDULA_CIUDADANIA', '10615', 'FEMENINO', 'DOCENTE', 'Maicol', 'Paredes', '3225864404',1);
INSERT INTO usuario (ID, CORREO, TIPO_DOCUMENTO, NUMERO_DOCUMENTO, SEXO, TIPO_USUARIO, NOMBRE, APELLIDO, TELEFONO, PROGRAMA_ID) VALUES (6, 'sebastian@unicauca.edu.co', 'CEDULA_CIUDADANIA', '10616', 'MASCULINO', 'PREGRADO', 'Sebastian', 'Perez', '3225864404', 2);
INSERT INTO usuario (ID, CORREO, TIPO_DOCUMENTO, NUMERO_DOCUMENTO, SEXO, TIPO_USUARIO, NOMBRE, APELLIDO, TELEFONO, PROGRAMA_ID, DEPARTAMENTO_ID) VALUES (7, 'miguelmonje@unicauca.edu.co', 'CEDULA_CIUDADANIA', '10613', 'MASCULINO', 'DOCENTE', 'Miguel', 'Monje', '3225864404',3, 1);
...
-- --ROL GRUPO
 ...
 INSERT INTO ROL_GRUPO (ID, ROL_GRUPO) VALUES(8,'ESTUDIANTE_POSTDOCTORADO');
...
-- -- integrante semillero
 ...
 INSERT INTO INTEGRANTE_SEMILLERO (ID_INTEGRANTE_SEMILLERO, SEMILLERO_ID, USUARIO_ID, ROL_ID, ESTADO, FECHA_INGRESO, FECHA_RETIRO) VALUES (2,4,6,2, 'ACTIVO', TO_DATE('2023-09-04', 'YYYY-MM-DD'),NULL);
 ...
 INSERT INTO INTEGRANTE_SEMILLERO (ID_INTEGRANTE_SEMILLERO, SEMILLERO_ID, USUARIO_ID, ROL_ID, ESTADO, FECHA_INGRESO, FECHA_RETIRO) VALUES (4,3,5,3, 'ACTIVO', TO_DATE('2023-09-04', 'YYYY-MM-DD'),NULL);
